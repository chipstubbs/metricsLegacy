...
class cProjects extends MY_Controller {
	...
	function view($id = FALSE)
	{
		...
		$this->view_data['project_has_invoices'] = Invoice::find('all',array('conditions' => array('project_id = ? AND company_id=? AND issue_date<=?',$id,$this->client->company->id,date('Y-m-d', time()))));
