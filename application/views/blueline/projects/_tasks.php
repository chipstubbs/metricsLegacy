...
<?php } ?>
 <div class="form-group">
        <label for="name">asdfasdf<?=$this->lang->line('application_task_name');?> *</label>
...
<div class="form-group">
        <label for="custom1">Custom One</label>
        <input id="custom1" type="number" name="custom1" class="form-control" value="<?php if(isset($task)){echo $task->custom1;} ?>" />
</div>
