<div class="row">
            ...
            <div class="table-head"><?=$this->lang->line('application_project_details');?></div>
				...
				<li><span><?=$this->lang->line('application_assigned_to');?>:</span> <?php foreach ($project->project_has_workers as $workers):?> <a class="label label-info" style="padding: 2px 5px 3px;"><?php echo $workers->user->firstname." ".$workers->user->lastname;?></a><?php endforeach;?> </li>
				    <li><span>Event Type:</span> <?php /*switch ($project->event) {
                             case "ss":
                                 echo "Social Security";
                                 break;
                             case "rmd":
                                 echo "RMD";
                                 break;
                             ...
                             case "taxpro":
                                 ...
                                 break;
                            case "college":
                                echo "College Planning";
                                break;
                            case "federalemployee":
                                echo "Federal Employee Benefits Specialist";
                                break;
                            case "teacherpro":
                                echo "Teacher Pro";
                                break;
                            ...
                            case "platinumreferral":
                                echo "Platinum Referrals";
                                break;
                             default:
                                 echo "No Event Type Assigned";
                        }*/ ?></li>
                  </ul>
