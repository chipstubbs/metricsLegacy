...
<div class="edit-table-head">Event Metrics</div>
    ...
    <?php if ($project->event != 'radio'): ?><div class="row"  id="mailer">
        <div class="col-xs-12 col-md-6">
    ...
    <div class="form-group">
          <label for="total_responses"><?php if($project->event == 'radio'){ echo "Call Ins"; } else { echo "Total Responses"; } ?> *</label>
    ...
    <div class="row">
        <div class="col-xs-12 col-md-6">
            <div class="form-group">
                  <label for="attended">Total Attended</label>
                  <input type="text" name="attended" class="form-control" id="attended"  value="<?php if(isset($project)){echo $project->attended; } ?>" />
            </div>
        </div>
        <div class="col-xs-12 col-md-6">
            <div class="form-group">
                  <label for="bu_attended"><?php if ($project->event === 'platinumreferral') { echo "Total Referral Buying Units Attended"; }else{ echo "Total Buying Units Attended"; } ?></label>
