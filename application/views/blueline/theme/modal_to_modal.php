<?php $this->session->set_userdata('refer_from', 'clientpage'); ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
 ...
 <a href="#" class="menu-trigger"><i class="fa fa-bars visible-xs"></i></a>
    ...
    <div class="content-area" onclick="">
      ...
      <span><a href="<?=site_url("logout");?>" title="<?=$this->lang->line('application_logout');?>"><i class="fa fa-sign-out"></i></a></span>
        ...
        <?php $modalclass = $this->uri->rsegment(1, 0); ?>
         <div class="modal-dialog <?php echo $modalclass; ?>">
            <div class="modal-content">
              <div class="modal-header">
                <a class="close" onClick='location.replace("http://metrics.advisorsacademy.com/clients");' data-dismiss="modal"><i class="fa fa-times"></i></a>
                <h4 class="modal-title"><?=$title;?></h4>
              </div>
              <div class="modal-body hide-closer">
    ...
    <!-- Plugins -->
        ...
        <!-- DataTables -->
        <script type="text/javascript" charset="utf8" src="https://cdn.datatables.net/1.10.6/js/jquery.dataTables.min.js"></script>
