...
//Ajax reply form submit
  ...
  $(document).on("click", '.taskform #send', function (e) {
    ...
    var content = $('textarea[name="description"]').html($('.modal-body .note-editable').code());
...
//Clickable rows
	$(document).on("click", 'table#projects td, table#reports td, table#events td, table#clients td, table#invoices td, table#cprojects td, table#cinvoices td, table#quotations td, table#messages td, table#cmessages td, table#subscriptions td, table#csubscriptions td, table#tickets td, table#ctickets td', function (e) {
    ...
    $(document).on("click", 'table#eventOverview td', function (e) {
      var id = $(this).parent().attr("id");
      if(id){
          var site = $(this).closest('table').attr("rel");
          if(!$(this).hasClass('option')){window.location = site+"reports/view/"+id;}
      }
    });
  ...
  //   $(document).on("click", 'table#completedAcats td', function (e) {
  //   var id = $(this).parent().attr("id");
  //   var pid = $(this).parent().data('sheet');
  //   if(id && pid){
  //     var site = $(this).closest('table').attr("rel");
  //     if(!$(this).hasClass('option')){window.location = site+"projects/productionentry/"+pid+"/update/"+id;}
  //   }
  // });
